  ...
  return (
    ...
    >
      <path
        ...
        className="transition-colors duration-300 ease-in-out fill-[#2F2E30] group-hover:fill-white"
      />
      <circle
        cx="40"
        cy="40"
        r="29"
        className="transition-colors duration-300 ease-in-out fill-black group-hover:fill-white"
      />
      <path
        ...
        className="transition-colors duration-300 ease-in-out stroke-white group-hover:stroke-black"
        strokeWidth="2"
        strokeLinecap="round"
